			...
			<div class="row">
				...
				<div><h4 style="margin: 0;">Add a machine</h4></div>
					...
					<table>
						...
						<tr><td>Part Number:</td><td><input value='${jobDetails.partNumber}' id="partNumber" name="partNumber"/></td></tr>
						<tr><td>Details:</td><td><textarea id="details" name="details"></textarea></td></tr>
						<tr><td>Quantity:</td><td><input value='${jobDetails.qunatity}' id="quantity" name="quantity"/></td></tr>
						<tr><td>Production Order Number:</td><td><input value='${jobDetails.productionOrderNumber}' id="orderNo" name="orderNo"/></td></tr>
						<tr>
						<td>Shift:</td>
						...
						<td><input value='${jobDetails.workingHours}' id="total_working_hours" type="text" name="total_working_hours" /></td>
						</tr>
						<!-- <tr>
						...
						<td><input value='${jobDetails.breakdownHours}' type="text" name="breakDown" id="breakDown" /></td>
						</tr>
						<tr>
						<td>Remarks:</td>
